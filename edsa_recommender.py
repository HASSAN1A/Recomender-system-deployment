...
###########################################################################################
    ...
    if page_selection == "Exploratory Data Analysis":
        ...
        # Rating v number of ratings
            ...
            plt.tight_layout()
            st.pyplot()
            st.write('They correlate, The more ratings a movie has, the more highly it is likely to be rated. This confirms our intuitive understanding that the more highly recommended a movie is, the more likely it is to be well received by the user.')
...
###########################################################################################
    ...
    if page_selection == "Introduction":
        ...
        st.markdown("<h2 style='text-align: center;'>Team 3</h1>", unsafe_allow_html=True)
        ...
        if info_page_selection == "Contributors":
            ...
            # Hassan
            st.markdown("<h3 style='text-align: center;'>Hassan Juma</h3>", unsafe_allow_html=True)
            st.markdown("<p style='text-align: center;'>Notebook Coordinator | ML Engineer</p>", unsafe_allow_html=True)
            st.image('https://avatars.githubusercontent.com/u/68612030?s=400&u=a7d16ca01b1411029caca4cbbe3a0755a6e8c274&v=4', width=120)
            st.markdown("<a href='https://www.linkedin.com/in/hassan-juma-b0a530101/' target='_blank'>LinkedIn</a>", unsafe_allow_html=True)
            st.markdown("<a href='https://github.com/HASSAN1A' target='_blank'>GitHub</a>", unsafe_allow_html=True)

            # Davis
            st.markdown("<h3 style='text-align: center;'>Davis Njogu</h3>", unsafe_allow_html=True)
            st.markdown("<p style='text-align: center;'>ML Engineer</p>", unsafe_allow_html=True)
            st.image('https://avatars.githubusercontent.com/u/11289047?v=4', width=120)
            st.markdown("<a href='https://www.linkedin.com/in/kabirodavies/' target='_blank'>LinkedIn</a>", unsafe_allow_html=True)
            st.markdown("<a href='https://github.com/kabirodavies' target='_blank'>GitHub</a>", unsafe_allow_html=True)
